...
function createtime1() {
  var grt = new Date("31/12/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
  ...
  var ascll = [
    ...
    `Future is now 🍭🍭🍭`,
    `
    _   __    ____    __ __   ____            ____     __    ____    ______
   / | / /   /  _/   / //_/  / __ \          / __ )   / /   / __ \  / ____/
  /  |/ /    / /    / ,<    / / / /         / __  |  / /   / / / / / / __  
 / /|  /   _/ /    / /| |  / /_/ /         / /_/ /  / /___/ /_/ / / /_/ /  
/_/ |_/   /___/   /_/ |_|  \____/         /_____/  /_____/\____/  \____/                                                                         
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by N1ko %c 你正在访问N1koの博客",
...
function createtime() {
  ...
  var start = new Date("01/01/2024 00:00:00"); // 旅行者1号开始计算的时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<div>努力一定会有收获</div><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<div>该休息啦</div><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://w.wallhaven.cc/full/we/wallhaven-wewodx.jpg);
    --darkmode-bg:url(https://w.wallhaven.cc/full/m3/wallhaven-m3rdg8.jpg);
    --mobileday-bg: url(https://w.wallhaven.cc/full/l8/wallhaven-l8rm9y.png);
    --mobilenight-bg: url(https://w.wallhaven.cc/full/85/wallhaven-85pjk1.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
